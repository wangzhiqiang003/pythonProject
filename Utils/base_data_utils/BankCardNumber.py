...
class GetBankCardNumber(object):
    def __init__(self,binNum='622676'):
        self.binNum = binNum
        self.midNum = ""
        self.lastCode = ""
        self.bankCardNumber = ""
    ...
    def getBinNum(self, useRandom=True):
        ...
        bankToBin = json.load(open("json/banknametobin.json", encoding="utf-8"))
        if useRandom:
            print("随机生成一个银行bin号......")
    ...
    def getBankCardNumber(self, useRandom=False):
        if useRandom:
            self.getBinNum()
